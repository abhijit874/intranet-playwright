...
test('technical classroom training — future date is rejected by the server', async ({ page }) => {
...
test('technical classroom training — previous-quarter date is rejected by the server', async ({ page }) => {
